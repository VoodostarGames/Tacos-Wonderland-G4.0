...
func _ready():
	var _err1 =  PlayerInventory.connect("active_item_updated",Callable(self,"update_active_item_label"))
	for i in range(slots.size()):
		var _err2 = PlayerInventory.connect("active_item_updated",Callable(slots[i],"refresh_style"))
